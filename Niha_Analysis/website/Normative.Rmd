...
df <- read.csv("/Users/Niha/Data-Analysis-BrainCheck/Niha_Analysis/cleaned_data/03_17_17.csv")
...
e <-ggplot()  + geom_histogram(data = trails, breaks = seq(0,10, by = .6), aes( y =..ncount.., x = trails$trails_b_duration_mean), col = "black", fill = "purple" ) 
...
d <- ggplot()  + geom_histogram(data = balance, breaks = seq(13,300, by = 10), aes( y =..ncount.., x = balance$balance_mean_distance_from_center), col = "black", fill = "purple" ) 
...
c <- ggplot()  + geom_histogram(data = delayed_recall, breaks = seq(5,20, by = .75), aes( y =..ncount.., x = delayed_recall$delayed_recall_correct), col = "black", fill = "purple" ) 
